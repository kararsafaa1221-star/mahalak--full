...
function JoyrideFloater(props) {
  ...
  const tooltipMiddleware = (0, import_react39.useMemo)(() => isCenter ? [{
    name: "center",
    fn: ({ rects }) => ({
    ...
    ...step.floatingOptions?.hideArrow ? [] : [arrow3({
      element: arrowRef,
  ...
  const beaconFloating = useFloating({
    ...
    middleware: (0, import_react39.useMemo)(() => [offset3(step.floatingOptions?.beaconOptions?.offset ?? -18)], [step.floatingOptions?.beaconOptions?.offset]),
  ...
  if (lifecycle === LIFECYCLE.TOOLTIP || lifecycle === LIFECYCLE.TOOLTIP_BEFORE) {
    ...
    content = import_react39.default.createElement("div", {
      ...
      size: size3,
      step
    }), !isCenter && !step.floatingOptions?.hideArrow && import_react39.default.createElement(Arrow, {
