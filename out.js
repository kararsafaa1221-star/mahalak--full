...
// src/lib/firebase.ts
var firebaseConfig = {
  apiKey: import.meta.env.VITE_FIREBASE_API_KEY || firebase_applet_config_default.apiKey || "dummy-api-key",
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || firebase_applet_config_default.authDomain || "dummy-auth-domain",
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || firebase_applet_config_default.projectId || "dummy-project-id",
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || firebase_applet_config_default.storageBucket || "dummy-storage-bucket",
  messagingSenderId: import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID || firebase_applet_config_default.messagingSenderId || "dummy-sender-id",
  appId: import.meta.env.VITE_FIREBASE_APP_ID || firebase_applet_config_default.appId || "dummy-app-id"
};
